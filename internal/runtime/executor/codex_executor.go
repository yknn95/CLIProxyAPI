...
func (e *CodexExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	for attempt := 0; attempt < attempts; attempt++ {
		...
		respAttempt, errAttempt, retryable := e.finishCodexNonStreamResponse(ctx, reporter, httpResp, req.Model, from, to, originalPayload, body, attemptIdentityState)
		if errAttempt == nil {
...
func (e *CodexExecutor) finishCodexNonStreamResponse(ctx context.Context, reporter *helps.UsageReporter, httpResp *http.Response, requestModel string, from sdktranslator.Format, to sdktranslator.Format, originalPayload []byte, body []byte, identityState codexIdentityConfuseState) (cliproxyexecutor.Response, error, bool) {
